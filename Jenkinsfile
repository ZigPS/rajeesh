	...
	stage ('Archival Stage') {
	  ...
	  if( datas.data.package == 'maven')
		...
		withMaven(maven : 'maven_3_5_3') {
			    ...
			    nexusPublisher nexusInstanceId: 'Nexus2', nexusRepositoryId: 'SampleMavenProject', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: '/target/my-app.war']], mavenCoordinate: [artifactId: 'my-app', groupId: 'com.mycompany.app', packaging: 'war', version: '1.0']]]
